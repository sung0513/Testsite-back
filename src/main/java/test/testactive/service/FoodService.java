...
public class FoodService {
    ...
    public Long save(FoodSaveRequestDto foodSaveRequestDto) { //사용자가입력한 정보 저장됨(정확히는 클릭한정보)
        return food2Repository.save(foodSaveRequestDto.toEntity()).getId(); //인터페이스를 사용하지않을경우 id값이 안땡겨짐
    }
